...
void playRound(Deck& playerDeck, Deck& computerDeck, SidePile& playerSide, SidePile& computerSide, int& playerScore, int& computerScore) {
    ...
    string playerChoice;
    cout << "\nYou have " << playerDeck.getNumCards() << " cards in your deck, and the computer has " << computerDeck.getNumCards() << 
        ". You have " << playerSide.RemainingCards() << " cards in your stack, and the computer has " << computerSide.RemainingCards() << ".\n";
    if (playerSide.RemainingCards() != 5 && playerSide.RemainingCards() != 0) {
        cout << "The card on top of your deck is " << playerDeck.peek() << " and there are "<< playerSide.RemainingCards()
            << " cards remaining in your sidePile. Would you like to (2) play it and the top card of your stack or (1) push it to your stack and play the next card?" << endl;
